...
import { Routes, Route, Navigate, useNavigate } from 'react-router-dom'; // Remove BrowserRouter from here
        ...
        <Routes>
          {!isAuthenticated ? (
            <>
              ...
              <Route path="/pin-login" element={<PinEntryForm onSuccess={handleLoginSuccess} onSwitchToLogin={() => navigate('/login')} />} />
            ...
            <>
              ...
              <Route path="/pin-login" element={<Navigate to="/" replace />} /> {/* Corrected to /pin-login */}
