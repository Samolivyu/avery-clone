...
import { Printer, Monitor, Box, Truck, Search, Sliders } from 'lucide-react';
import { 
  Collapsible,
  CollapsibleContent,
  CollapsibleTrigger,
...
const ProductCard = ({ id, name, description, imagePath, category }: ProductCardProps) => {
  return (
  ...
  const products: ProductCardProps[] = [
    {
      ...
      imagePath: "/public/lovable-uploads/43b52e67-2be0-4ee5-a33d-5ca91ca761cd.png",
    ...
    },
    {
      ...
      imagePath: "/public/lovable-uploads/780ada2d-9fdd-4963-8e49-f3bd53b5053c.png",
      category: "Printers"
    },
    {
      id: 3,
      ...
      imagePath: "/public/lovable-uploads/a53ded91-ae09-4f35-9ddc-9ba90eefe3f3.png",
    ...
    },
    {
      ...
      imagePath: "/public/lovable-uploads/3bde147d-c4ee-43a9-a43b-3e78eea830d8.png",
            ...
            <div className="flex flex-col md:flex-row gap-6">
              ...
              <div className="hidden md:block w-1/4">
                <div className="bg-white shadow-md rounded-md overflow-hidden">
                  <div className="bg-weightech-black text-white p-4">
                  ...
                  <div className="p-4 border-b">
                    <ul className="space-y-2">
                      {productCategories.map(category => (
                        <li key={category}>
                          <button
                            className={`text-left w-full py-1 px-2 rounded-md transition ${selectedCategory === category ? 'bg-weightech-red text-white' : 'hover:bg-gray-100'}`}
                            onClick={() => {
                              if (selectedCategory === category) {
                                setSelectedCategory(null);
                              } else {
