          ...
          <tr>
            <td valign="top">
              ...
              <div>
                ...
                <p style={{ textAlign: 'justify' }}>We can tailor a maintenance package to suit your specific needs and if a contract is not for you and you simply need a one-off repair we can offer fixed-cost callouts and a free quotation for any parts required.&nbsp;</p>
                <p style={{ textAlign: 'justify' }}>When you choose Avery (EA) as your service provider you will have access to over 20 highly trained and accredited field-based technicians, a fleet of over fifteen service pickups, and a dedicated local service manager who will personally monitor your account.</p>
                <p style={{ textAlign: 'justify' }}>Detailed management reports, including breakdowns of machines, call-to-fix details, and planned maintenance reports will be provided on a regular basis.</p>
              </div>
              <p><br />&nbsp;</p>
            </td>
          </tr>
